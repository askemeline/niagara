...
export default {
  components: { Navigation, Steppers },
  computed: {
    format: {
      get() {
...
setGenderMutation(state, gender){ state.gender = gender; }, setGenderAction(context, gender){
